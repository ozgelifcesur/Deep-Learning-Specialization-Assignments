...
def compute_cost_with_regularization(A3, Y, parameters, lambd):
    ...
    L2_regularization_cost =(1/m)*(lambd/2)*np.sum(np.sum(np.square(parameters['W' + str(1)]))+np.sum(np.square(parameters['W' + str(2)]))+np.sum(np.square(parameters['W' + str(3)])))
    ### END CODER HERE ###
...
def backward_propagation_with_regularization(X, Y, cache, lambd):
    ...
    ### START CODE HERE ### (approx. 1 line)
    dW3 = 1./m * np.dot(dZ3, A2.T) + (lambd/m)*cache[10]
    ### END CODE HERE ###
    ...
    ### START CODE HERE ### (approx. 1 line)
    dW2 = 1./m * np.dot(dZ2, A1.T) + (lambd/m)*cache[6]
    ### END CODE HERE ###
    ...
    ### START CODE HERE ### (approx. 1 line)
    dW1 = 1./m * np.dot(dZ1, X.T) + (lambd/m)*cache[2]
    ### END CODE HERE ###
